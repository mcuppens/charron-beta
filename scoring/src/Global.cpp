...
double tStartSoar     = 0.;
double tEndSoar       = 0.;
int    nFixMax        = 20000;  // Maximum number of fixes in a soaring block
...
UINT TC0G = GetTickCountOwn();

void StartTiming(void)
{ TC0G = GetTickCountOwn();
}



void EndTiming(char *msg)
{ if ( debugAny ) printf ( "Time spent %s: %d ms\n", msg, GetTickCountOwn() - TC0G );
  TC0G = GetTickCountOwn();
}
